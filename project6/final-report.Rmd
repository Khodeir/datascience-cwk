...
Instead of measuring completion rates, we can also make use of the well supported notion that “more time spent course leads to higher completion rates” and use “time spent on online course materials” as our metric. This can be a shorter experiment, possibly spanning only a few months. 
